...
"[project]/apps/bookae_viewer/app/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ViewerHomePage() {
    ...
    if ($[0] !== "e537ba458e0f54e2a9338b2dcf8f035873576d7a5aa0d1812b9ce6b2ff7c0c8d") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e537ba458e0f54e2a9338b2dcf8f035873576d7a5aa0d1812b9ce6b2ff7c0c8d";
    }
    ...
    const currentReferer = ("TURBOPACK compile-time truthy", 1) ? document.referrer : "TURBOPACK unreachable";
    let t0;
    if ($[1] !== searchParams) {
        t0 = getVideoIdFromUrl(searchParams, currentUrl || undefined);
        $[1] = searchParams;
        $[2] = t0;
    } else {
        t0 = $[2];
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = getVideoIdFromReferer(currentReferer);
        $[3] = t1;
    } else {
        t1 = $[3];
    }
    const refererVideoId = t1;
    const finalVideoId = urlVideoId || refererVideoId;
    if ("TURBOPACK compile-time truthy", 1) {
        console.log("Current URL:", currentUrl);
        console.log("Current URL videoID:", urlVideoId);
        console.log("Referer:", currentReferer);
        console.log("Referer videoID:", refererVideoId);
        console.log("Final videoID:", finalVideoId);
    }
    let t2;
    if ($[4] !== finalVideoId) {
        t2 = {
...
_s(ViewerHomePage, "a+DZx9DY26Zf8FVy1bxe3vp9l1w=", false, function() {
    return [
...
_c = ViewerHomePage;
var _c;
__turbopack_context__.k.register(_c, "ViewerHomePage");
...
//# sourceMappingURL=_82058fee._.js.map