...
"[project]/apps/bookae_viewer/lib/utils/videoId.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$bookae_viewer$2f$lib$2f$utils$2f$videoId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/bookae_viewer/lib/utils/videoId.ts [app-client] (ecmascript)");
;
...
function ViewerHomePage() {
    ...
    if ($[0] !== "e9e803e4216cf8aace600433593e0af57ee7a790dc07598a699441f776c91375") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e9e803e4216cf8aace600433593e0af57ee7a790dc07598a699441f776c91375";
    }
    ...
    let t0;
    if ($[1] !== searchParams) {
        t0 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$bookae_viewer$2f$lib$2f$utils$2f$videoId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractVideoId"])(searchParams, currentUrl, currentReferer);
        $[1] = searchParams;
        $[2] = t0;
    } else {
        t0 = $[2];
    ...
    let t1;
    if ($[3] !== result.source || $[4] !== result.videoId) {
        t1 = {
    ...
    const { videoId, referer, source } = t1;
    let t2;
...
//# sourceMappingURL=_810c9019._.js.map